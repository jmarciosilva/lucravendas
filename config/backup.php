    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Sem backup de arquivos (somente banco via --only-db no Schedule)
                'include' => [],
        ...
        'destination' => [
            ...
            /*
             * Os backups são armazenados no S3 (configurado no .env como AWS_*).
             * Em desenvolvimento local, use 'local' para testes rápidos.
             */
            'disks' => [
                env('BACKUP_DISK', 's3'),
            ],
